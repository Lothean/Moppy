...
public class MoppyPlayerOutput implements MoppyReceiver {
    ...
    public static int[] microPeriods = {
        122312, 115444, 108968, 102852, 97080, 91636, 86488, 81636, 77052, 72728, 68644, 64792, // Whatever these notes are
        61156, 57722, 54484, 51426, 48540, 45818, 43244, 40818, 38526, 36364, 34322, 32396, // C0 - B0
